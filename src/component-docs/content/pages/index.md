...
1. **[Project Tour](/component-docs/project-tour/)**: Understand the directory structure, how components are organized, and the three-file pattern that makes everything visually editable.
